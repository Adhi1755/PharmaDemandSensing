...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen flex">
            {/* Left panel */}
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-purple-700 to-indigo-900 relative overflow-hidden">
                <div className="absolute top-1/3 left-1/3 w-72 h-72 bg-white/5 rounded-full blur-2xl"></div>
            ...
            <div className="flex-1 flex items-center justify-center px-6 py-12 bg-slate-50">
                <div className="w-full max-w-md">
                    ...
                    <p className="text-slate-500 mb-8">Get started with PharmaSense AI</p>
